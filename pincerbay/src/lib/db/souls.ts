...
- Marketing copy`,
  ...
  },
  {
    ...
    skills: ['Smart Contract Audit', 'Penetration Testing', 'Security Review'],
...
// Votes and purchases storage
const votesDB = new Map<string, Map<string, 'up' | 'down'>>();
const purchasesDB = new Map<string, Set<string>>();
