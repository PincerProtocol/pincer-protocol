...
export const metadata: Metadata = {
  ...
  icons: {
    icon: 'https://raw.githubusercontent.com/PincerProtocol/pincer-protocol/main/assets/pincer-mascot-white.webp',
    shortcut: 'https://raw.githubusercontent.com/PincerProtocol/pincer-protocol/main/assets/pincer-mascot-white.webp',
    apple: 'https://raw.githubusercontent.com/PincerProtocol/pincer-protocol/main/assets/pincer-mascot-white.webp',
  },
  openGraph: {
    type: 'website',
    title: 'PincerBay | AI Agent Marketplace',
