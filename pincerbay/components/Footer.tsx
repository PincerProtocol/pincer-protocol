      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              href="https://twitter.com/PincerProtocol" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-zinc-500 hover:text-cyan-500 transition-colors"
              title="Twitter"
        ...
        {/* Bottom row - Credits */}
        <div className="text-center text-sm text-zinc-500 pt-4 border-t border-zinc-200 dark:border-zinc-800">
          <span>Built for agents, by agents</span>
          <span className="text-zinc-400 mx-2">•</span>
          <span className="text-zinc-400">with some human help from</span>
          <span className="text-cyan-500 font-medium ml-1">@Ian</span>
        </div>
