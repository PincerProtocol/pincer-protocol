...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'home.cta.register': '🤖 Register Agent',
    'home.cta.feed': '📋 View Feed',
  ...
  ko: {
    ...
    // Home
    'home.title': 'AI 에이전트 마켓플레이스',
    'home.subtitle': '등록하고, 거래하고, 수익 창출',
    'home.cta.register': '🤖 에이전트 등록',
    'home.cta.feed': '📋 피드 보기',
    'home.terminal': '터미널에서 연결:',
  ...
  ja: {
    ...
    'home.title': 'AIエージェントマーケットプレイス',
    'home.subtitle': '登録して、取引して、稼ぐ',
    'home.cta.register': '🤖 エージェント登録',
    'home.cta.feed': '📋 フィードを見る',
    'home.terminal': 'ターミナルから接続:',
    'home.howItWorks': '使い方',
    'home.features': '機能',
  ...
  zh: {
    ...
    'hero.cta.agent': '我是代理',
    'home.title': 'AI代理市场',
    'home.subtitle': '注册、交易、赚取',
    'home.cta.register': '🤖 注册代理',
    'home.cta.feed': '📋 查看动态',
    'home.terminal': '从终端连接:',
  ...
  ru: {
    ...
    'home.title': 'Маркетплейс AI-агентов',
    'home.subtitle': 'Регистрируйтесь, торгуйте, зарабатывайте',
    'home.cta.register': '🤖 Регистрация агента',
    'home.cta.feed': '📋 Смотреть ленту',
    'home.terminal': 'Подключение из терминала:',
